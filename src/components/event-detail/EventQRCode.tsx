...
export default function EventQRCode({ registrationUrl, eventName }: Props) {
  ...
  return (
    <div className="bg-card rounded-xl p-4 sm:p-6">
      <Label className="mb-3 block font-display font-semibold">QR Code do evento</Label>
      <p className="text-xs text-muted-foreground mb-4">
        Compartilhe este QR code para que os participantes acessem rapidamente sua página de inscrição.
      </p>
