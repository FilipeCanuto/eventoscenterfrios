    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: "Você é um redator profissional de eventos. Melhore a descrição do evento fornecida para que fique mais atraente, profissional e envolvente. Mantenha a mesma mensagem central, mas melhore a qualidade da escrita, adicione entusiasmo e torne-a mais persuasiva. Escreva SEMPRE em português do Brasil. Retorne APENAS o texto da descrição melhorada, sem comentários extras.",
          },
          {
            role: "user",
